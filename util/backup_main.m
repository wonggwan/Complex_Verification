...
% Break formulas to several sub-tasks
% define sub-tasks online
% eventually go to either room 1 or room 2, and once you do that, go to
% room 3 or room 4, and always avoid room 5
% mask - sub-NN
% Encoder - Decoder
% generate ground truth that goes to room #
% task 1: go to room 1 and avoid room 5 -> try to verify if that's
% possible; if not, ask algo to give a new task ( go to room 2 and avoid
% room 5)
% verify all the sub-tasks until the final
